...
function MobileNav({ open, setOpen }: any) {
  return (
    <div
      className={`absolute top-0 left-0 h-screen w-screen bg-gradient-to-t md-4 bg-nile-blue-700 transform ${
        open ? "-translate-x-0" : "-translate-x-full"
      } transition-transform duration-300 ease-in-out filter drop-shadow-md `}
    >
      <div className="flex items-center justify-center filter drop-shadow-md bg-gradient-to-t bg-nile-blue-700 h-20">
        {" "}
        {/*logo container*/}
...
export default function Navbar() {
  ...
  return (
    <nav className="flex filter drop-shadow-md bg-gradient-to-t bg-nile-blue-700 px-4 py-4 h-20 items-center md-4">
